...
if($row=db_simpleSelect(0,$GLOBALS['Tu'],$GLOBALS['dbUserSheme']['user_sorttopics'][1].','.$GLOBALS['dbUserSheme']['language'][1].', '.$GLOBALS['dbUserSheme']['user_customlastvisit'][1].', '.$GLOBALS['dbUserSheme']['num_posts'][1],$GLOBALS['dbUserId'],'=',1)) {
$GLOBALS['user_sort']=$row[0];
$GLOBALS['langu']=$row[1];
$GLOBALS['user_customlastvisit']=$row[2];
$GLOBALS['user_num_posts']=$row[3];
}
else{
$GLOBALS['user_sort']=0;
...
$username=$row[5];
$GLOBALS['user_customlastvisit']=$row[6];
$GLOBALS['user_num_posts']=$row[7];
